  ...
  return (
    <div className="safehome-container">
      ...
      {(emotions.length >0) ? (
         ...
         <Link to={`/safearea/${emotions[0].emotion_id}`} className="safehome-category-btn">{emotions[0].name}</Link>
         <Link to={`/safearea/${emotions[1].emotion_id}`} className="safehome-category-btn">{emotions[1].name}</Link>
         <Link to={`/safearea/${emotions[2].emotion_id}`} className="safehome-category-btn">{emotions[2].name}</Link>
         </div>
         <div className="safehome-category-column">
         <Link to={`/safearea/${emotions[3].emotion_id}`} className="safehome-category-btn">{emotions[3].name}</Link>
         <Link to={`/safearea/${emotions[4].emotion_id}`} className="safehome-category-btn">{emotions[4].name}</Link>
         <Link to={`/safearea/${emotions[5].emotion_id}`} className="safehome-category-btn">{emotions[5].name}</Link>
         </div>
       </div>
      ) : (
        <p>Fetching...</p>
