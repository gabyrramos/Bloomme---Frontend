  ...
  return (
    <section id="assistant">
      <div className="landingassistant">
        ...
        />
        <p>
          Briefly explain how the virtual assistant can respond to questions
          about topics like:
        </p>
        <ul>
          <li>
          ...
          <li>
            <img src={star} alt="star" className="star" />
            &nbsp;Advice on friendships and relationships
          </li>
        </ul>
        ...
        <div className="quote-container">
          ...
          <p className="quote">
            <i>
              To get started, simply type your questions or choose a topic
              you're interested in. We’re here to provide information and
              support in a safe, private space.
            </i>
          </p>
        </div>
      </div>
